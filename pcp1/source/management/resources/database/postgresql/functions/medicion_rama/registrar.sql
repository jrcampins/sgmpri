create or replace function medicion_rama$registrar$biz(_super$ bigint, _medicion$ bigint, _observaciones$ character varying) returns integer as $$
declare
...
begin
    raise notice 'medicion_rama$registrar$biz(%, %, %)', _super$, _medicion$, _observaciones$;
