...
call:check-jar-file "%third_party_dir%\lib\jasperreports-4.0.0.jar"
...
call:check-jar-file "%third_party_dir%\lib\commons-collections-3.2.1.jar"
call:check-jar-file "%third_party_dir%\lib\commons-digester-1.7.jar"
call:check-jar-file "%third_party_dir%\lib\commons-fileupload-1.2.2.jar"
call:check-jar-file "%third_party_dir%\lib\commons-io-2.1.jar"
call:check-jar-file "%third_party_dir%\lib\commons-javaflow-20060411.jar"
call:check-jar-file "%third_party_dir%\lib\commons-lang-2.6.jar"
call:check-jar-file "%third_party_dir%\lib\commons-logging-1.1.jar"
call:check-jar-file "%third_party_dir%\lib\iText-2.1.7.jar"
call:check-jar-file "%third_party_dir%\lib\jasperreports-4.0.0.jar"
call:check-jar-file "%third_party_dir%\lib\jasperreports-chart-themes-4.0.0.jar"
call:check-jar-file "%third_party_dir%\lib\jasperreports-extensions-3.5.3.jar"
call:check-jar-file "%third_party_dir%\lib\jasperreports-fonts-4.0.0.jar"
