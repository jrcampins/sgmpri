...
set USER_DIR=%project_source_dir%\meta-pcp1
set USER_DIR 1>>%LOG_FILE%
set USER_DIR
if not exist "%USER_DIR%" echo. & pause & goto:eof
set JAR="%USER_DIR%\dist\meta-pcp1.jar"
set JAR 1>>%LOG_FILE%
set JAR
...
call:add-to-classpath "%third_party_dir%\lib\commons-fileupload-1.2.2.jar"
...
call:add-to-classpath "%third_party_dir%\lib\jasperreports-4.0.0.jar"
